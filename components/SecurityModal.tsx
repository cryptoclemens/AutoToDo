    ...
    <>
      {trigger ? (
        ...
        <button
          ...
          className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-md text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
        >
          <span>🛡️</span>
      ...
      {open && createPortal(
        <div
          role="dialog"
          aria-modal="true"
          aria-label="Datensicherheit & Datenschutz"
        ...
        >
          ...
          {/* Modal panel */}
          <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] flex flex-col overflow-hidden mx-4">
            {/* Header */}
            <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700 shrink-0">
              <div>
                <h2 className="text-base font-bold text-gray-900 dark:text-gray-100">Datensicherheit & Datenschutz</h2>
                <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Technische und organisatorische Maßnahmen (TOMs)</p>
              </div>
              <button
                onClick={() => setOpen(false)}
                className="text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-200 text-xl leading-none ml-4 transition-colors"
            ...
            <div className="overflow-y-auto px-6 py-5 space-y-4 flex-1">
              ...
              {/* LLM Disclaimer */}
              <div className="bg-amber-50 dark:bg-amber-950/40 border border-amber-200 dark:border-amber-800 rounded-xl p-4 mt-2">
                <p className="text-xs font-semibold text-amber-800 dark:text-amber-300 mb-1">⚠ Haftungshinweis – Externe KI-Anbieter</p>
