  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 max-w-3xl mx-auto px-6 py-12 w-full">
        ...
        {updatedAt && (
          <p className="text-sm text-gray-400 mb-10">{t('lastUpdated')} {updatedAt}</p>
        )}
      ...
      <footer className="border-t border-gray-100 py-8 mt-12">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-400">
            <Link href="/agb" className="hover:text-gray-600 transition-colors">{t('agb')}</Link>
            <Link href="/datenschutz" className="hover:text-gray-600 transition-colors">{t('datenschutz')}</Link>
            <Link href="/impressum" className="hover:text-gray-600 transition-colors">{t('impressum')}</Link>
            <Link href="/datensicherheit" className="hover:text-gray-600 transition-colors">{t('datensicherheit')}</Link>
          </div>
        </div>
      </footer>
    </div>
