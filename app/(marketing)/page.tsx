            ...
            {[
              {
                ...
                desc: 'Meeting-Protokoll oder Transkript (.txt) hochladen – fertig.',
              },
              {
                icon: '🤖',
                title: 'KI extrahiert Aufgaben',
                desc: 'Neue LOP-Punkte, Statusänderungen und Ergebnisse werden automatisch erkannt.',
              },
              {
                icon: '📊',
                title: 'LOP immer aktuell',
                desc: 'Tabellarische Übersicht, editierbar, filterbar. Export als XLSX mit Ihrem Branding.',
              },
            ].map(f => (
